{
  ...
  outputs = {
    ...
    mkNixOnDroidConfiguration = {
      ...
      # Import Android utilities from common/lib
      # Provides: glibc, gccLib, fakechroot, patchPackage, installationDir
      ...
      patchPackageForAndroidGlibc = android.patchPackage;
    in
  ...
  in {
    ...
    packages = forAllSystems (system: let
      ...
      # Expose Android packages for aarch64-linux (uses common/lib/android.nix)
      androidPackages =
    ...
    # Export Android utilities for external use (uses common/lib/android.nix)
    lib = {
      aarch64-linux = let
        android = import ./common/lib/android.nix {
      ...
      in {
        inherit (android) androidGlibc androidFakechroot patchPackageForAndroidGlibc;
      };
    };
